			...
			if ($resultCode == RESTConstants::$RESP_LITERAL_AUT) {
				...
				switch ($version[0]) {
					...
					case "1":
						...
						escribirLog("DEBUG", $idLog, "Endpoint para continuar V1: " . $response ["url"], null, __METHOD__);
					break;
